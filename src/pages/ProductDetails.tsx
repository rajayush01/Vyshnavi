        ...
        <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="flex gap-2 overflow-x-auto px-8">
              {images.map((img, idx) => (
                <div
                  ...
                  className={`min-w-20 h-20 bg-gray-100 rounded border-2 cursor-pointer ${
                    selectedImage === idx
                      ? "border-blue-700"
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-600">1188 reviews</span>
            </div>

            {/* Price */}
            <div className="flex items-baseline gap-3">
              <span className="text-5xl font-bold">₹4949</span>
              <span className="text-2xl text-gray-400 line-through">₹5050</span>
            </div>
            <p className="text-xs text-gray-500">MRP (Incl. of all taxes)</p>

            {/* Best Price Badge */}
            <div className="relative inline-block text-white px-4 py-2 rounded-lg text-sm font-semibold overflow-hidden bg-blue-700 hover:scale-105 transition-all duration-300">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-bold">₹590</p>
                    </div>
                  </div>
                </div>
                <button className="bg-white border-2 border-blue-700 text-blue-700 px-6 py-2 rounded-full font-semibold hover:bg-blue-50">
                  <ShoppingCart/>
                </button>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex gap-4 w-full">
                <button className="flex-1 bg-blue-700 text-white py-3 px-6 rounded-full font-semibold hover:bg-blue-800">
                  Add to cart
                </button>
                <button className="flex-1 bg-yellow-400 text-gray-900 py-3 px-6 rounded-full font-semibold hover:bg-yellow-500">
                  Buy Now
                </button>
              </div>
            </div>
            ...
            {/* Features Grid */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-6 pb-8">
              {features.map((feature: Feature, idx: number) => (
                <div
                  key={idx}
                  className="flex flex-col items-center text-center"
                >
                  <div className="text-blue-700 mb-3">{feature.icon}</div>
